...
const ListingForm = (props) => {
  ...
  const { sale_type, price, bedrooms, home_type, bathrooms, sqft, days_listed,
    has_photos, open_house, keywords} = formData;
  ...
  const onSubmit = e => {
    ...
    setLoading(true);
    axios.post("http://127.0.0.1:8000/listings/search", {sale_type, price, bedrooms, home_type, bathrooms, sqft, days_listed,
      has_photos, open_house, keywords})
    .then(res => {
      setLoading(false);
